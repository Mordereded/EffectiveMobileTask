...
Для запуска тестов Вы можете открыть решение в VS и нажать на кнопку запуска тестов, либо запустить их из программы нажав на соответствующую кнопку. Изначально файл, в который выводится лог и файл для результата находятся по пути Project_test_task\ResultingFile и Project_test_task\LoggerTextFile соответственно.
